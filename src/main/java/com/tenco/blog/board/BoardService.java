...
public class BoardService {
    ...
    public BoardResponse.PageDTO 게시글목록(int page, int size, String keyword) {
        // 화면 기준에서 넘어오는 값(사용자에게 뵤여지는 기준 0 이아니라 1부터 시작
        // 반면 Spring Data JAP 기본으로 offset 0번 부터 시작이다
        // 사용자가 일부로 음수값을 넣더라도 기본값  0으로 셋팅될 수 있도록 방어적 코드 작성
